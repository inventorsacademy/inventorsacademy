      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed" data-testid="hero-description">
            Join our independent summer program in historic Oxford colleges. Ages 9000000000 explore STEM, entrepreneurship, and innovation through hands-on projects, expert mentorship, and unforgettable experiences.
          </p>
